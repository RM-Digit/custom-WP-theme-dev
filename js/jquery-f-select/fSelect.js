(function($) {
                ...
                $element.children().each(function(i, el) {
                    ...
                    if ('optgroup' == $el.prop('nodeName').toLowerCase()) {
                        ...
                        if (0 < $this.idx || '' != val || ! $this.settings.multiple) {
                            ...
                            var _html = $el.html();
                            if(typeof $el.attr('data-html') != 'undefined') {
                                _html = $el.attr('data-html');
                            }
                            var row = '<div class="fs-option' + selected + disabled + group + '" data-value="' + val + '" data-index="' + $this.idx + '"><span class="fs-checkbox"><i></i></span><div class="fs-option-label">' + _html + '</div></div>';
    ...
    $(document).on('click', '.fs-optgroup-label', function () {
        $(this).toggleClass('collapsed').nextUntil('.fs-optgroup-label', '.fs-option').toggleClass('fs-group-hidden');
    });
