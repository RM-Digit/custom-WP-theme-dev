...
<article class="card article newsletter" <?php // post_class('card article newsletter position-relative'); ?> id="post-<?php the_ID(); ?>">
    <div class="card-body">
    ...
    <div class="article-content">
        ...
        <div class="col-md-5 px-0">
            ...
            <?php
            $customer_portrait = get_post_meta(get_the_ID(), 'quest-customer-portrait', true);
            if ($article_post_type == QUEST_POST_TYPE_CUSTOMER_STORY && !empty($customer_portrait)) :
            ?>
                <a href="<?php echo esc_url( get_permalink() );?>" rel="bookmark">
		            <?php echo wp_get_attachment_image($customer_portrait);?>
                </a>
            <?php else: ?>
                <a href="<?php echo esc_url( get_permalink() );?>" rel="bookmark">
        ...
        <div class="col-md-7 newsletter-item-content pl-md-3 px-0">
            <header class="entry-header">
                ...
                <div class="entry-title">
	                <?php $targetBlank = in_array($article_post_type, get_all_target_blank_post_types()) ? '' : ''; ?>
