...
<div class="wrapper" id="resource-wrapper">
        ...
        <div class="bounder">
            <div class="container">
                <h1 class="search-header-title">
                    <?php _e('Archived Press Releases', 'quest');?>
                </h1>
            </div>
        </div>
    </div>
    <div class="container" id="content" tabindex="-1">
        ...
        <div class="row">
            ...
            <form id="press-release-sort" method="get" action="<?php echo get_post_type_archive_link(QUEST_POST_TYPE_RESOURCE_PRESS_RELEASE);?>">
            <?php quest_sortable();?>
            </form>
            </div>
        </div>
