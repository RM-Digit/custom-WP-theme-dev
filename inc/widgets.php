...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
        ...
        register_sidebar( array(
            ...
            'name'              => __( 'Footer Ours Services', 'quest' ),
            'id'                => 'questfooter-ours-services',
            /* translators: %d : footer id counter */
            'description'       => __( 'Add widgetized footer region ours services.', 'quest' ),
            'before_widget'     => '<aside id="%1$s" class="widget %2$s">',
            'after_widget'      => '</aside>',
        ...
        register_sidebar( array(
            /* translators: %d : footer id counter */
            'name'              => __( 'Footer Secondary Navigation Links', 'quest' ),
            'id'                => 'questfooter-navigation-links',
            /* translators: %d : footer id counter */
            'description'       => __( 'Add widgetized footer region secondary navigation links.', 'quest' ),
            'before_widget'     => '<aside id="%1$s" class="widget %2$s">',
            'after_widget'      => '</aside>',
            'before_title'      => '<h5 class="widget-title">',
            'after_title'       => '</h5>',
        ...
        register_sidebar( array(
            /* translators: %d : footer id counter */
            'name'              => __( 'Footer Secondary Navigation Links For Home', 'quest' ),
            'id'                => 'questfooter-home-navigation-links',
            /* translators: %d : footer id counter */
            'description'       => __( 'Add widgetized footer region secondary navigation links.', 'quest' ),
            'before_widget'     => '<aside id="%1$s" class="widget %2$s">',
            'after_widget'      => '</aside>',
